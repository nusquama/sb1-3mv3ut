    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      ...
      >
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-xl">Recent Reviews</h3>
          ...
          {business.photos_sample && business.photos_sample.length > 0 && (
            <div className="mt-8">
              <h3 className="font-semibold text-xl mb-4">Photos</h3>
              <div className="grid grid-cols-4 gap-4">
                {business.photos_sample.map((photo, index) => (
                  <img
                    ...
                    onClick={() => setSelectedImage(photo.photo_url_large)}
                  />
                ))}
              </div>
            </div>
